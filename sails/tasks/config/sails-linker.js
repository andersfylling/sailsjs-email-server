    ...
    grunt.config.set('sails-linker', {
        devJs: {
            options: {
                startTag: '<!--SCRIPTS-->',
                endTag: '<!--SCRIPTS END-->',
                fileTmpl: '<script src="//localhost%s"></script>',
                appRoot: '.tmp/public'
            },
            files: {
        ...
        prodJs: {
            options: {
                startTag: '<!--SCRIPTS-->',
                endTag: '<!--SCRIPTS END-->',
                fileTmpl: '<script src="//codewolf.red%s"></script>',
                appRoot: '.tmp/public'
            },
            files: {
        ...
        prodStyles: {
            options: {
                startTag: '<!--STYLES-->',
                endTag: '<!--STYLES END-->',
                fileTmpl: '<link rel="stylesheet" href="//codewolf.red%s">',
                appRoot: '.tmp/public/styles'
            },
            files: {
